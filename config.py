...
class Config:
    ...
    db_path: str        # SQLite path (legacy compat layer)
    ...
    # App
    test_mode: bool
    parser_enabled: bool   # PARSER_ENABLED=0 отключает парсинг продаж
    admin_password: str
    bot_version: str
...
def load_config() -> Config:
    ...
    if not bot_token:
        raise ValueError("BOT_TOKEN not found. Create .env with BOT_TOKEN=...")
    ...
    return Config(
        ...
        parser_enabled=_bool(os.getenv("PARSER_ENABLED"), default=True),
