...
# Раз в 6 часов (± джиттер). Внутренние стадии (rebind/audit/coords-центроиды)
# дешёвые — SQL по своей БД. Внешние (krisha_complex, coords-страницы,
# geocode) ограничены лимитом за цикл, поэтому чаще не даёт больше пользы.
MIN_INTERVAL_H = 6 - 1
MAX_INTERVAL_H = 6 + 1
...
GEOCODE_BATCH = 200            # адресов за цикл (Nominatim 1 req/s => ~3-4 мин)
